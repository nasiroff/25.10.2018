...
public class BlogDaoImpl implements BlogDao {
    ...
    private final String GET_ALL_BLOGS_AND_COMMENT_COUNT = "select * from post p inner join user u on p.id_user = u.id_user left join comment c on p.id_post = c.id_post order by p.share_date desc limit ? offset ?";
